...
def read_graph_from_file(file_path):
        ...
        for edge in edges_str.split(","):
            ...
            if edge:
                try:
                    ...
                    print(f"Warning: Invalid edge format '{edge}' in file {file_path}. Skipping this edge.")
    else:
    ...
    return V_num, list(edges), weight

def solve_dominating_set(V_num, edges, weight):
    model = Cplex()
    ...
    for i in range(1, V_num + 1):
        neighbors = [j for (u, v) in edges if u == i or v == i]
...
if __name__ == "__main__":
    folder_path = "C:/Users/GodAeolus/Desktop/cplex_python/cplex_graph_udg_weight"
    output_txt_file = "C:/Users/GodAeolus/Desktop/cplex_python/results/results_udg_weight.txt"
    ...
    for file_name in tqdm(files, desc="Processing files", unit="file"):
        ...
        try:
            ...
            total_dominating_vertices, solve_time = solve_dominating_set(V_num, edges, weight)
